...
/**
 *  \file       core/modules/sav/doc/pdf_standard.modules.php
 *  \ingroup    sav
...
/**
 *	Class to manage PDF template standard_bon
 */
class pdf_standard_bon extends ModelePDFBon
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_BON_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->sav->dir_output.'/bon')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->sav->dir_output.'/bon';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->sav->dir_output.'/bon/'.$objectref;
