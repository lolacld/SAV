...
/**
 * \file    test/phpunit/SavFunctionalTest.php
 * \ingroup sav
 ...
 * @package Testsav
 */
class SavFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/sav/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('sav/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/sav/admin/about.php');
		$this->authenticate();
		return $this->assertContains('sav/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('savwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSav_SavTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSav_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
